...
description: 'Discover repos under TargetProjects and update governance inventory'
---
...
```
Read and follow all instructions in: lens.core/_bmad/lens-work/prompts/lens-work.discover.prompt.md
```

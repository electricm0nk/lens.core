...
- When 'A' selected: Read fully and follow: {project-root}/_bmad/core/workflows/advanced-elicitation/workflow.yaml
...
- Read fully and follow: {project-root}/_bmad/core/workflows/advanced-elicitation/workflow.yaml with the current responsive/accessibility content

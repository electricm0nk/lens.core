...
SUBMODULE_NAME="$(basename "$(dirname "$(dirname "${MODULE_DIR}")")")"
...
> All \`_bmad/\` paths in the full prompt are relative to \`${SUBMODULE_NAME}/\` — do NOT resolve paths against the user's main project repo.

\`\`\`
Read and follow all instructions in: ${SUBMODULE_NAME}/_bmad/lens-work/prompts/${target_prompt}
\`\`\`
${extra}
EOF
}
...
IT IS CRITICAL THAT YOU FOLLOW THIS COMMAND: LOAD the FULL @${SUBMODULE_NAME}/_bmad/lens-work/${workflow_path}, READ its entire contents and follow its directions exactly!
EOF
}
...
1. LOAD the module config from ${SUBMODULE_NAME}/_bmad/lens-work/module.yaml
2. LOAD the FULL agent definition from ${SUBMODULE_NAME}/_bmad/lens-work/agents/lens.agent.md
3. READ its entire contents - this contains the complete agent persona, skills, lifecycle routing, and phase-to-agent mapping
4. LOAD the lifecycle contract from ${SUBMODULE_NAME}/_bmad/lens-work/lifecycle.yaml
5. LOAD the module help index from ${SUBMODULE_NAME}/_bmad/lens-work/module-help.csv
...
- **Module path:** `${SUBMODULE_NAME}/_bmad/lens-work/`
- **Lifecycle contract:** `${SUBMODULE_NAME}/_bmad/lens-work/lifecycle.yaml`
- **Module version:** See `${SUBMODULE_NAME}/_bmad/lens-work/module.yaml`

## Agent

The `@lens` agent is defined at `.github/agents/bmad-agent-lens-work-lens.agent.md` and references
the module agent at `${SUBMODULE_NAME}/_bmad/lens-work/agents/lens.agent.md`.

## Skills (by path reference)

| Skill | Path |
|-------|------|
| git-state | `${SUBMODULE_NAME}/_bmad/lens-work/skills/git-state.md` |
| git-orchestration | `${SUBMODULE_NAME}/_bmad/lens-work/skills/git-orchestration.md` |
| constitution | `${SUBMODULE_NAME}/_bmad/lens-work/skills/constitution.md` |
| sensing | `${SUBMODULE_NAME}/_bmad/lens-work/skills/sensing.md` |
| checklist | `${SUBMODULE_NAME}/_bmad/lens-work/skills/checklist.md` |
...
- **Module path:** \`${SUBMODULE_NAME}/_bmad/lens-work/\`
- **Agent definition:** \`${SUBMODULE_NAME}/_bmad/lens-work/agents/lens.agent.md\`
- **Lifecycle contract:** \`${SUBMODULE_NAME}/_bmad/lens-work/lifecycle.yaml\`
- **Module config:** \`${SUBMODULE_NAME}/_bmad/lens-work/module.yaml\`
...
See \`${SUBMODULE_NAME}/_bmad/lens-work/module-help.csv\` for the complete command list.

...
- Agent manifest CSV is available at `{project-root}/_bmad/custom_agents/active/agent-manifest.csv`
...
Load and parse the agent manifest CSV from `{project-root}/_bmad/custom_agents/active/agent-manifest.csv`

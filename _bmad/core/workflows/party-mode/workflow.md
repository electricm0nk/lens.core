...
- Agent manifest path: `{project-root}/_bmad/custom_agents/active/agent-manifest.csv`

### Paths

- `installed_path` = `{project-root}/_bmad/core/workflows/party-mode`
- `agent_manifest_path` = `{project-root}/_bmad/custom_agents/active/agent-manifest.csv`
